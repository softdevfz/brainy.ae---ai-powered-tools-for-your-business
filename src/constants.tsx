...
export const HeartIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M21 8.5c0-1.939-1.569-3.5-3.5-3.5-1.035 0-1.973.452-2.615 1.163a5.53 5.53 0 00-.885 1.063 5.53 5.53 0 00-.885-1.063A3.468 3.468 0 009.5 5C7.569 5 6 6.561 6 8.5c0 1.264.668 2.368 1.666 2.987.283.176.589.316.912.418C10.121 12.481 12 13.5 12 13.5s1.879-1.019 3.422-1.595c.323-.102.629-.242.912-.418C17.332 10.868 18 9.764 18 8.5c0 0 3 1.5 3 0z" />
    </svg>
);
...
export const PRODUCTS: Product[] = [
    ...
    },
    {
        id: 'knot',
        name: 'BrainyKnot',
        tagline: 'Your AI Wedding Guest Concierge',
        description: 'An intelligent wedding assistant that helps your guests with everything they need. From travel arrangements to local recommendations, your AI concierge ensures every guest feels welcomed and informed.',
        features: [],
        url: 'https://knot.brainy.ae'
    },
    {
        id: 'slot',
        name: 'BrainySlot',
        tagline: 'AI Phone & Appointment Operator',
        description: 'Never miss a call or appointment again. Our AI operator handles phone calls, schedules appointments, and manages your calendar 24/7, ensuring your business is always accessible.',
        features: [],
        url: 'https://slot.brainy.ae'
    }
];
...
export const PRICING_PLANS: PricingPlan[] = [
    ...
    {
        productId: 'knot',
        productName: 'BrainyKnot',
        productTagline: 'Your AI Wedding Guest Concierge',
        price: 99,
        trial_days: 14,
        features: [
            ...
            "RSVP management",
            "Custom wedding website integration",
        ]
    },
    {
        productId: 'slot',
        productName: 'BrainySlot',
        productTagline: 'AI Phone & Appointment Operator',
        price: 30,
        trial_days: 14,
        features: [
...
export const CHATBOT_SYSTEM_INSTRUCTION = {
  role: "model",
  parts: [{ text: `You are a friendly and helpful sales assistant for Brainy.ae. Your goal is to explain our four AI products and convince users to sign up for a free trial or contact us.
...
3. BrainyKnot (AI Wedding Guest Concierge):
- What it is: An intelligent wedding assistant that helps your guests with everything they need.
- How it works: Provides personalized assistance to wedding guests for travel arrangements, local recommendations, and event information.
- Key Features: 24/7 availability, personalized recommendations, multi-language support.
- Target Audience: Couples planning weddings who want to provide exceptional guest experience.
- Visit: knot.brainy.ae

4. BrainySlot (AI Phone & Appointment Operator):
- What it is: Never miss a call or appointment again. Our AI operator handles phone calls and manages appointments 24/7.
- How it works: AI answers calls, schedules appointments, manages your calendar, and ensures your business is always accessible.
- Key Features: 24/7 availability, intelligent call routing, appointment scheduling, calendar integration.
- Target Audience: Service businesses, medical practices, consultants, anyone who needs appointment management.
- Visit: slot.brainy.ae
...
- Pricing: 
  - BrainyPOS: $20/month (30-day free trial)
  - BrainyStooge: $20/month (30-day free trial)
  - BrainyKnot: $99/month (14-day free trial) - Perfect for wedding events
  - BrainySlot: $30/month (14-day free trial) - 24/7 phone answering service
- Contact: Call or WhatsApp us at (231) 427-2469 (+1-231-4BRAINY) for any questions!
...
- Gently guide users towards the free trial or suggest they call us.
- If you don't know an answer, say that you're a specialized AI for Brainy.ae products and can't answer that, but you can explain more about our products or they can call us at (231) 427-2469.
